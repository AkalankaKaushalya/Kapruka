...
import com.kapruka.databinding.ActivityAskAdminBinding;
import com.squareup.picasso.Callback;
import com.squareup.picasso.Picasso;

import java.util.HashMap;

public class AdminAskActivity extends AppCompatActivity {
    ActivityAskAdminBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAskAdminBinding.inflate(getLayoutInflater());
        ...
        binding.addsendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text.isEmpty()) {
                    Toast.makeText(AdminAskActivity.this, "Enter Discription", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void loadeText(String text) {
        ...
        hashMap.put("AQusetionID", "" + timestamp);
        hashMap.put("UserID", "" + firebaseAuth.getUid());
        hashMap.put("City", "" + City);
        hashMap.put("AQusetionTitle", "" + text);
        hashMap.put("AQusetionImage", "" + "img");
        hashMap.put("AQusetionVideo", "" + "video");
    ...
    private void loadeImage(String text) {
        ...
        progressDialog.show();
        String filePathAndName = "AskAdmin/" + timestamp + "/" + "Image/" + "img";  //Qusetion/0112514525/Image/
        ...
        ref.putFile(ImageUrl)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        hashMap.put("City", "" + City);
                        hashMap.put("AQusetionTitle", "" + text);
                        hashMap.put("AQusetionImage", "" + uploadedImageUrl);
                        hashMap.put("AQusetionVideo", "" + "video");
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("AskAdmin");
                        ref.child(timestamp)
                                .setValue(hashMap)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(AdminAskActivity.this, "Failed Upload Image", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void loadeVideo(String text) {
        ...
        progressDialog.show();
        String filePathAndName = "AskAdmin/" + timestamp + "/" + "Video/" + "video";  //Qusetion/0112514525/Image/
        StorageReference ref = FirebaseStorage.getInstance().getReference(filePathAndName);
        ref.putFile(VideoUrl)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        hashMap.put("AQusetionTitle", "" + text);
                        hashMap.put("AQusetionImage", "" + "img");
                        hashMap.put("AQusetionVideo", "" + uploadedVideoUrl);
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("AskAdmin");
                        ref.child(timestamp)
                                .setValue(hashMap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
