...
public class AskAdminCommnentsAdapter extends RecyclerView.Adapter<AskAdminCommnentsAdapter.PostCommnetsHolder> {
    public List<AskAdminCommnetsModel> askAdminCommnetsModelList;
    ...
    public AskAdminCommnentsAdapter(List<AskAdminCommnetsModel> askAdminCommnetsModelList, Context context) {
        this.askAdminCommnetsModelList = askAdminCommnetsModelList;
    ...
    public void onBindViewHolder(@NonNull PostCommnetsHolder holder, int position) {
        AskAdminCommnetsModel codeModel = askAdminCommnetsModelList.get(position);
    ...
    public int getItemCount() {
        return askAdminCommnetsModelList.size();
    }
